...
"
    >
      ...
      <button className="text-base font-normal text-primary-dark px-4 py-[2px] bg-[#00D9F5]/20 rounded-full">
        Gemini Powered
      </button>
      <div className="flex flex-col items-center justify-center gap-2">
        <h1 className="text-5xl md:text-6xl lg:text-8xl font-bold font-Oxanium">
          QuickDoc{" "}
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#00F5A0] to-[#00D9F5]">
            AI
          </span>
        </h1>
        <p className="text-base mb-4 md:mb-0 md:text-lg font-Sora text-center mt-4 max-w-2xl">
